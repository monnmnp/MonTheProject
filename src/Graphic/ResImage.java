...
public class ResImage {
	...
	public static Image blueberry,strawberry,milk,yogurt,vanilla,chocolate,banana,honey;
	...
	public static Image blender,blender2;
	public static Image replayd,replayb,bin,recipe,recipeBtn;
	public static Image blendBY,blendCB,blendCH,blendSB,blendSS,blendVM;
	public static AudioClip buttonS,buttonS2,blenderS,titleS,playS,timeupS;
	...
	public static void loadResource() {
		try {
			...
			buttonS = new AudioClip(ClassLoader.getSystemResource("sound/button-1.mp3").toString());
			buttonS2 = new AudioClip(ClassLoader.getSystemResource("sound/button-10.mp3").toString());
			blenderS = new AudioClip(ClassLoader.getSystemResource("sound/blender.mp3").toString());
			playS = new AudioClip(ClassLoader.getSystemResource("sound/playS.mp3").toString());
			titleS = new AudioClip(ClassLoader.getSystemResource("sound/titleS.mp3").toString());
			timeupS = new AudioClip(ClassLoader.getSystemResource("sound/timeup.mp3").toString());
		}
		catch (Exception e){
